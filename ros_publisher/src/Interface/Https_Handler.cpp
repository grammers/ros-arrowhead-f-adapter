	...
	curl_global_init(CURL_GLOBAL_ALL);
  	...
  	if(curl)
  	{
		...
		if (pmethod == "PUT")
          ...
          //--cert
          if ( curl_easy_setopt(curl, CURLOPT_SSLCERT,        "/home/grammers/catkin_ws/src/ros-arrowhead-f-adapter/provider_client/keys/clcert.pem")  != CURLE_OK)
               printf("error: CURLOPT_SSLCERT\n");
          //--cert-type
          if ( curl_easy_setopt(curl, CURLOPT_SSLCERTTYPE,    "PEM")         != CURLE_OK)
               printf("error: CURLOPT_SSLCERTTYPE\n");
          //--key
          if ( curl_easy_setopt(curl, CURLOPT_SSLKEY,         "/home/grammers/catkin_ws/src/ros-arrowhead-f-adapter/provider_client/keys/privkey.pem") != CURLE_OK)
          ...
          //--cacert
          if ( curl_easy_setopt(curl, CURLOPT_CAINFO,         "/home/grammers/catkin_ws/src/ros-arrowhead-f-adapter/provider_client/keys/cacert.pem")  != CURLE_OK)
